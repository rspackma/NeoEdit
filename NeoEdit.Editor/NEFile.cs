	...
	public partial class NEFile : INEFile
	{
		...
		public void Execute()
		{
			switch (state.Command)
			{
				...
				case NECommand.Position_Goto_Lines: Execute__Position_Goto_Lines__Position_Goto_Columns__Position_Goto_Indexes__Position_Goto_Positions(GotoType.Line); break;
				case NECommand.Position_Goto_Columns: Execute__Position_Goto_Lines__Position_Goto_Columns__Position_Goto_Indexes__Position_Goto_Positions(GotoType.Column); break;
				case NECommand.Position_Goto_Indexes: Execute__Position_Goto_Lines__Position_Goto_Columns__Position_Goto_Indexes__Position_Goto_Positions(GotoType.Index); break;
				case NECommand.Position_Goto_Positions: Execute__Position_Goto_Lines__Position_Goto_Columns__Position_Goto_Indexes__Position_Goto_Positions(GotoType.Position); break;
				...
				case NECommand.Diff_Next: Execute__Diff_Next__Diff_Previous(true); break;
				case NECommand.Diff_Previous: Execute__Diff_Next__Diff_Previous(false); break;
